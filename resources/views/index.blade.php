        ...
        <div class="main-menu">
          <nav class="navigation">
            <ul class="nav menu">
              ...
              <li><a href="#">Kategori <i class="icofont-rounded-down"></i></a>
                <ul class="dropdown">
                  <li><a href="404.html">Pemuda Pelopor</a></li>
                  <li><a href="404.html">Pertukaran Pemuda antar Provinsi</a></li>
                  <li><a href="404.html">Pertukaran Pemuda antar Negara</a></li>
                </ul>
              </li>
              <li><a href="#">Alur Seleksi </a></li>
              <li>
                <a href="#">Berita <i class="icofont-rounded-down"></i></a>
                <ul class="dropdown">
                  <li><a href="404.html">404 Error</a></li>
                </ul>
              </li>
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                  <div class="copyright-content">
                    <p>
                      © Copyright 2025 | All Rights Reserved by Tim RPL Informatika Unsoed
                    </p>
                  </div>
                </div>
              </div>
